...
public class AdaptrtDar extends BaseAdapter {
    ...
    public AdaptrtDar(ArrayList<Servies> list, Context context) {
        this.list = list;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        recCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(context, Detils_Darclin.class);
